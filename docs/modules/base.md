...
- Platform macros ([c/platform.h](../../include/ball/types/c/platform.h)): `BALL_MSVC`, `BALL_GNUC`, `BALL_CLANG`, `BALL_MINGW`, `BALL_ARM`/`BALL_ARM64`/`BALL_X86`, `BALL_32BITS`/`BALL_64BITS`, `BALL_CXX`.
