...
- Platform macros ([c/platform.h](../../include/ball/types/c/platform.h)): `BALL_MSVC`, `BALL_GNUC`, `BALL_CLANG`, `BALL_MINGW`, `BALL_ARM`/`BALL_X86`, `BALL_32BITS`/`BALL_64BITS`, `BALL_CXX`.
...
- Miscellaneous C helpers under [c/](../../include/ball/types/c/): `debugbreak.h`, `unreachable.h`, `assume.h`, `prefetch.h` (`BALL_PREFETCH_READ`), `nouniqueaddress.h` (`BALL_NO_UNIQUE_ADDRESS`), `io.h`, `mmap.h`.
