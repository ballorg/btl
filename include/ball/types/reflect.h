#ifndef _INCLUDE_BALL_TYPES_REFLECT_H_
#	define _INCLUDE_BALL_TYPES_REFLECT_H_

/// Declares a uniquely tagged reflected value alias.
#	define BALL_REFLECT_TAGGED( name, type ) \
	struct M##name {}; \
	using name##_t = ::BTL::CReflect< type, M##name >

/// Declares a uniquely tagged reflected value alias template.
...
#endif // !defined( _INCLUDE_BALL_TYPES_REFLECT_H_ )
