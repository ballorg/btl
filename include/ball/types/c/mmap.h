...
#	define BALL_PROT_READ ( 1 << 0 )
#	define BALL_PROT_WRITE ( 1 << 1 )
#	define BALL_PROT_EXEC ( 1 << 2 )

#	define BALL_MAP_PRIVATE ( 1 << 1 )

#	if defined( BALL_APPLE )
#		define BALL_MAP_ANONYMOUS ( 1 << 12 )
#	elif defined( BALL_MCST )
#		define BALL_MAP_ANONYMOUS ( 1 << 4 )
#	else // !defined( BALL_APPLE ) && !defined( BALL_MCST )
#		define BALL_MAP_ANONYMOUS ( 1 << 5 )
